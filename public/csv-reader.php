...
<body>
    <div class="container-fluid">
        <div class="row" style="display: flex; flex-flow: column; height: 100vh;">
                    ...
                    <div class="col-12 col-md-5 col-lg-3 my-auto">
                        <div class="row">
                            ...
                            <div class="col-6 px-2 d-grid">
                                <button class="btn-custom btn-white-custom" data-bs-toggle="modal" data-bs-target="#fileImportModel">Import</button>
                            </div>
                    ...
                    <div class="col-12 col-md-8 col-lg-9 order-0 order-md-1">
                        <div class="row">
                            <div class="col-9 col-md-10 p-2 text-start text-md-end">
                                <span>Columns: </span>
                                <input class="number-input-custom" id="columns" disabled type="number" value="0" />
                                &nbsp;&nbsp;
                                <span>Rows: </span>
                                <input class="number-input-custom" id="rows" disabled type="number" value="0" />
                            </div>
            ...
            <!-- File Import Model - start -->
            <div class="modal fade" id="fileImportModel" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="fileImportModelLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            <label class="file-upload-area-custom cursor-hand col-12" id="fileUpArea">
                                <input type="file" accept=".csv, text/csv" id="uploadFile" class="img uploadFile d-none" value="Upload Photo" />
                                <p class="text-center fs-1">
                                    <i class="bi bi-filetype-csv"></i>
                                </p>
                                <p class="text-center" id="filename">Click here to upload a file</p>
                            </label>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn-custom btn-grey-custom" data-bs-dismiss="modal">Cancel</button>
                            <button type="button" class="btn-custom btn-green-custom" id="import" disabled data-bs-toggle="tooltip" title="Upload a file to proceed">Import</button>
                        </div>
                    </div>
                </div>
            </div>
            <!-- File Import Model - end -->
